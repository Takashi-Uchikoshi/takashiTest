...
namespace B2.Com
{
    ...
    public class Ime
    {
        ...
        public const uint ImeNyuryokuModeHankakuEisu = 0x0000;
        /// <summary>入力モード値　日本語</summary>
        public const uint ImeNyuryokuModeNihongo = 0x0001;
        /// <summary>入力モード値　カタカナ</summary>
        public const uint ImeNyuryokuModeKatakana = 0x0002;
        /// <summary>入力モード値　半角カタカナ</summary>
        public const uint ImeNyuryokuModeHankakuKatakana = 0x0003;
        /// <summary>入力モード値　全角</summary>
        public const uint ImeNyuryokuModeZenkaku = 0x0008;
        /// <summary>入力モード値　ローマ字入力</summary>
        public const uint ImeNyuryokuModeRomaji = 0x0010;
        /// <summary>入力モード値　文字コード入力</summary>
        public const uint ImeNyuryokuModeMojiCode = 0x0020;
        /// <summary>入力モード値　HANJA変換モード</summary>
        public const uint ImeNyuryokuModeHanjaHenkan = 0x0040;
        /// <summary>入力モード値　ソフトキーボード</summary>
        public const uint ImeNyuryokuModeSoftKeybord = 0x0080;
        /// <summary>入力モード値　変換しない</summary>
        public const uint ImeNyuryokuModeHenkanshinai = 0x0100;
        /// <summary>入力モード値　EUDC変換モード</summary>
        public const uint ImeNyuryokuModeEudcHenkan = 0x0200;
        /// <summary>入力モード値　</summary>
        public const uint ImeNyuryokuModeSymbol = 0x0400;
        /// <summary>入力モード値　</summary>
        public const uint ImeNyuryokuModeFixed = 0x0800;
        #endregion

        #region 変換モード値
        /// <summary>変換モード値　無変換</summary>
        public const uint ImeHenkanModeMuhenkan = 0x0000;
        /// <summary>変換モード値　人名/地名</summary>
        public const uint ImeHenkanModeJimmeiChimei = 0x0001;
        /// <summary>変換モード値　単漢字変換する</summary>
        public const uint ImeHenkanModeTankanji = 0x0002;
        /// <summary>変換モード値　自動モード</summary>
        public const uint ImeHenkanModeJido = 0x0004;
        /// <summary>変換モード値　一般</summary>
        public const uint ImeHenkanModeIppan = 0x0008;
        /// <summary>変換モード値　話し言葉</summary>
        public const uint ImeHenkanModeHanashikotoba = 0x0010;
        #endregion
