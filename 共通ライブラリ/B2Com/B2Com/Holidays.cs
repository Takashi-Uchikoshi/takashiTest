...
namespace B2.Com
{
    public class holidays
    {
        ...
        class Program
        {
            ...
            public void searchHoliday(DateTime Date,out Holiday holiday) 
            {
                // 日本の祝日・休日の日付一覧
                ...
                holiday = new Holiday();
                holiday.Date = Date;
                holiday.Kind = HolidayKind.平日;
                holiday.Name = "平日";
                holiday.Definition = Date.ToString("MM月dd日");
                ...
                foreach (var d in holidays.Values)
                {
                    if(d.Date == Date)
                    {
                        holiday.Kind = d.Kind;
                        holiday.Name = d.Name;
                        holiday.Definition = d.Definition;
                        break;
                    }
                }
