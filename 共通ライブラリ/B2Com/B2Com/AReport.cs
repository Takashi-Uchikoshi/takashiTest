...
namespace B2.Com
{
    ...
    public class AReport : IDisposable
    {
        ...
        private void SetFontData(ARControl control, string data)
        {
            ...
            if(control is Label)
            {
                ...
                lbl.Font = new Font(fontData[0], fontSize);
                if(alignSet)
                {
                    lbl.Alignment = align;
                }
            ...
            else if(control is TextBox)
            {
                ...
                tbx.Font = new Font(fontData[0], fontSize);
                if(alignSet)
                {
                    tbx.Alignment = align;
                }
    ...
    public class PaperSize
    {
        ...
        public static PaperKind GetPaperSize(string size)
        {
            switch(size)
            {
                case "A4":
                ...
                case "A6":
                    return PaperKind.A6;
                case "ﾊｶﾞｷ":
                    return PaperKind.JapanesePostcard;
            }
            return PaperKind.A4;
        }
    }
