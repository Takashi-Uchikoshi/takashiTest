...
{ 
	...
	[Table("課題管理")]
	public partial class 課題管理
	{
        [Key]
        [ForeignKey("プロジェクト名管理表")]
        [Column("プロジェクト番号", Order = 0)]
        public int? プロジェクト番号 { get; set; }

        //        public virtual ICollection<プロジェクト名管理表> pjkanris { get; set; }
        public virtual プロジェクト名管理表　プロジェクト名管理表  { get; set; }
        public string プロジェクト名  { get{return プロジェクト名管理表.プロジェクト名;} }
