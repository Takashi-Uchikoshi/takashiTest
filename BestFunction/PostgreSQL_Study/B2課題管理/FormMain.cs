    ...
    public partial class FormMain : Form
    {
        ...
        private void mfnc_putOutCsv()
        {
            try
            {
                ...
                // スプレッドの内容を取得
                //------------------
                lstrCsvDetail = lclsCnvStr.SheetViewToCsv(fpSMain.ActiveSheet);
        ...
        private bool dBselect_Kadai(decimal pj_no)
        {
            try
            {
                ...
                PhCom.PostLib.SQL.Append("\r\n      , A.\"原因詳細\"  ");
                PhCom.PostLib.SQL.Append("\r\n      , A.\"重要度\"  ");
                PhCom.PostLib.SQL.Append("\r\n      , to_char(A.\"発生日\",'HH') as \"発生日\" ");
                PhCom.PostLib.SQL.Append("\r\n      , to_char(A.\"対応予定日\",'HH') as \"対応予定日\"   ");
                PhCom.PostLib.SQL.Append("\r\n      , to_char(A.\"完了日\",'HH') as \"完了日\"   ");
                PhCom.PostLib.SQL.Append("\r\n      , A.\"指摘者\"  ");
                PhCom.PostLib.SQL.Append("\r\n      , A.\"処置者\"  ");
                PhCom.PostLib.SQL.Append("\r\n      , A.\"是正区分\"  ");
                PhCom.PostLib.SQL.Append("\r\n      , A.\"抽出グループ\"  ");
                PhCom.PostLib.SQL.Append("\r\n      , A.\"登録者\"  ");
                PhCom.PostLib.SQL.Append("\r\n      , to_char(A.\"登録日\",'HH') as \"登録日\"   ");
                PhCom.PostLib.SQL.Append("\r\n      , A.\"予定工数\"  ");
                PhCom.PostLib.SQL.Append("\r\n      , A.\"実績工数\"  ");
                PhCom.PostLib.SQL.Append("\r\n      , to_char(A.\"開発着手日\",'HH') as \"開発着手日\"   ");
                PhCom.PostLib.SQL.Append("\r\n      , to_char(A.\"開発完了日\",'HH') as \"開発完了日\"   ");
                PhCom.PostLib.SQL.Append("\r\n      , A.\"進捗率\"  ");
                PhCom.PostLib.SQL.Append("\r\n      , A.\"備考\"  ");
                PhCom.PostLib.SQL.Append("\r\n from \"課題管理\" A  ");
                PhCom.PostLib.SQL.Append("\r\n    , \"プロジェクト名管理表\" B  ");
                PhCom.PostLib.SQL.Append("\r\n where A.\"プロジェクト番号\" = '" + pj_no.ToString() + "' ");
                PhCom.PostLib.SQL.Append("\r\n   and A.\"プロジェクト番号\" = B.\"プロジェクト番号\" ");
                if (chk_tourokubi.Checked == true)
                {
                    PhCom.PostLib.SQL.Append("\r\n  and  trunc(A.\"発生日\",'HH')  between to_char(to_date('" + dateTimePicker1.Value.ToString("yyyy/MM/dd  HH:MM:SS") + "', 'YYYY-MM-DD HH:MM:SS'),'HH')  and  to_char(to_date('" + dateTimePicker2.Value.ToString("yyyy/MM/dd  HH:MM:SS") + "', 'YYYY-MM-DD HH:MM:SS'),'HH')");
                }
                ...
                {
                    PhCom.PostLib.SQL.Append("\r\n  and  A.\"抽出グループ\" like '%" + txt_group.Text.ToString() + "%'  ");
                }

                PhCom.PostLib.SQL.Append("\r\n  ORDER BY A.\"管理番号\",A.\"連番\"  ");
...
//                                                   "to_date(@KANRYOUBI, 'YYYY-MM-DD'),@SHITEKISYA,@SYOCHISYA,@ZESEIKUBUN," +
            ...
            cmd.Parameters.Add("pjNo", NpgsqlDbType.Numeric, 6, "プロジェクト番号");           //NUMBER
            cmd.Parameters.Add("SEQ_NO", NpgsqlDbType.Numeric, 5, "連番");                     //NUMBER
